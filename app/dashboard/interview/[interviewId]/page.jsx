    ...
    <div className='my-10 '>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 '>
         ...
         <div className='flex flex-col my-5 gap-5 '>
            ...
            <h2 className='text-lg'><strong>Job Description/Job Role :</strong>{interviewData.jobPosition}</h2>
             <h2 className='text-lg'><strong>Skills :</strong>{interviewData.jobDesc}</h2>
              <h2 className='text-lg'><strong>Years of Experience :</strong>{interviewData.jobExperience}</h2>
        </div>
            <div className='p-5 border rounded-lg border-amber-300 bg-amber-100'>
                <h2 className='flex gap-2 items-center text-yellow-600'><Lightbulb /><strong className='text-yellow-600'>Information</strong></h2>
