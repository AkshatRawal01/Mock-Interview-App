    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526]">
      <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 w-full max-w-md flex flex-col items-center">
        <div className="mb-6 flex flex-col items-center">
          ...
          <p className="text-gray-600 text-center text-lg">Welcome back! Sign in to continue practicing and improving your interview skills.</p>
        </div>
        <SignIn appearance={{ elements: { card: 'shadow-none', formButtonPrimary: 'bg-blue-600 hover:bg-blue-700' } }} />
      </div>
    </div>
  )
}